public class Data_DateTime_Instant {
    ...
    public static final java.util.function.Function<Object, Object> toDateTimeImpl = (ctorObj) -> {
        ...
        return (java.util.function.Function<Object, Object>) (instantObj) -> {
            ...
            System.out.println("toDateTimeImpl parsed: y=" + y + " mo=" + mo + " d=" + d + " h=" + h + " mi=" + mi + " s=" + s + " ms=" + ms);
...
public static final Object toDateTime = ((java.util.function.Function<Object, Object>) (Data_DateTime_Instant.toDateTimeImpl)).apply((java.util.function.Function<Object, Object>) (y_0) -> (java.util.function.Function<Object, Object>) (mo_1) -> (java.util.function.Function<Object, Object>) (d_2) -> (java.util.function.Function<Object, Object>) (h_3) -> (java.util.function.Function<Object, Object>) (mi_4) -> (java.util.function.Function<Object, Object>) (s_5) -> (java.util.function.Function<Object, Object>) (ms_6) -> new Data_DateTime.DateTime(((java.util.function.Function<Object, Object>) (((java.util.function.Function<Object, Object>) (((java.util.function.Function<Object, Object>) (Data_Date.canonicalDate)).apply(y_0))).apply(( ((Boolean) (java.util.Objects.equals(mo_1, 1))) ? new Data_Date_Component.January() : ( ((Boolean) (java.util.Objects.equals(mo_1, 2))) ? new Data_Date_Component.February() : ( ((Boolean) (java.util.Objects.equals(mo_1, 3))) ? new Data_Date_Component.March() : ( ((Boolean) (java.util.Objects.equals(mo_1, 4))) ? new Data_Date_Component.April() : ( ((Boolean) (java.util.Objects.equals(mo_1, 5))) ? new Data_Date_Component.May() : ( ((Boolean) (java.util.Objects.equals(mo_1, 6))) ? new Data_Date_Component.June() : ( ((Boolean) (java.util.Objects.equals(mo_1, 7))) ? new Data_Date_Component.July() : ( ((Boolean) (java.util.Objects.equals(mo_1, 8))) ? new Data_Date_Component.August() : ( ((Boolean) (java.util.Objects.equals(mo_1, 9))) ? new Data_Date_Component.September() : ( ((Boolean) (java.util.Objects.equals(mo_1, 10))) ? new Data_Date_Component.October() : ( ((Boolean) (java.util.Objects.equals(mo_1, 11))) ? new Data_Date_Component.November() : ( ((Boolean) (java.util.Objects.equals(mo_1, 12))) ? new Data_Date_Component.December() : (new java.util.function.Supplier<Object>() { public Object get() { throw new RuntimeException("Failed pattern match"); } }).get()))))))))))))))).apply(d_2), new Data_Time.Time(h_3, mi_4, s_5, ms_6)));
